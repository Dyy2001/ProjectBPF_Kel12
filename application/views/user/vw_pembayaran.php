            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Vertical Form -->
                        <form class="row g-3" action="<?= base_url('User/pembayaran/'). $santri[0]['id']?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="total" value="<?= $santri[0]['total']; ?>" class="form-control" id="total" readonly>
                            </div>
                            <div class="col-12">
                                <label for="pembayaran" class="form-label">Pembayaran</label>
                                <select name="pembayaran" value="<?=set_value('pembayaran') ?>" id="pembayaran" class="form-control">
                                    <option value="">Pilih Pembayaran</option>
                                    <option value="Mandiri 0101010101-0101010">Mandiri 0101010101-0101010</option>
                                    <option value="BRI 020202020202-0202020">BRI 020202020202-0202020</option>
                            ...
                            <div>
                                ...
                                <button type="submit" name="tambah" class="btn btn-primary justify-right">Simpan</button>
